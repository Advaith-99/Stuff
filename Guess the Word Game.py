import turtle                                         # importing turtle in the beginning for effective use 
...
def textDraw(cu,tFunction,wordLength,tAngle,lSpace,teXt,tSize,tFont,tAlign,tType,xCor,yCor,tColor,tSpeed): # the text function, which acts as 
    cu.ht()
    if(int(tFunction)== 1):                                                                                     # two fucntions in one                     
